...
class NewCompras extends StatefulWidget {

  const NewCompras({super.key});

  @override
  State<NewCompras> createState() => _NewComprasState();
}

class _NewComprasState extends State<NewCompras> {

  List<Map<String, dynamic>> proveedores = [];
  List<Map<String, dynamic>> productos = [];
  List<Map<String, dynamic>> detalles = [];

  Map<String, dynamic>? proveedoreSeleccionado;
  ...
  Future<void> cargarDatos() async {
    ...
    final prov = await db.getProveedoresCompra();
  ...
  List<Map<String, dynamic>> filtrarClientes(String filtro) {
    return proveedores.where((proveedores) => proveedores['empresa'].toLowerCase().contains(filtro.toLowerCase())).toList();
  }
                      ...
                      children: [
                        Container(
                          ...
                          child: Autocomplete<Map<String, dynamic>>(
                            displayStringForOption: (c) => c['empresa'],
                            ...
                            onSelected: (Map<String, dynamic> selection) {
                              setState(() {
                                proveedoreSeleccionado = selection;
                                proveedorController.text = selection['empresa'];
                              });
                            },
                            fieldViewBuilder: (context, controller, focusNode, onFieldSubmitted) {
                              ...
                              return CustomTextFormField(
                                ...
                                label: 'Buscar o seleccionar Empresa',
                              );
                            },
                          ),
                        ),
